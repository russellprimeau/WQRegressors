...
if __name__ == "__main__":
    ...
    reuse_split = False  # Reuse a previous train/test split from .txt files in data_dir/forecasts_name/
    ...
    # Flatten train and test sets (required for XGB structure) and ensure outputs are binary
